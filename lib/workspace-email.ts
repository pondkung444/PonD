...
export function personnelEmailHtml(fullName: string, academicYear: number) {
  ...
  return `<!doctype html><html lang="th"><body style="margin:0;background:#f4f6f4;font-family:Arial,'Noto Sans Thai',sans-serif;color:#1c2a21"><div style="max-width:620px;margin:0 auto;padding:28px 16px"><div style="background:#fff;border:1px solid #dfe7e1;border-radius:12px;padding:28px"><h1 style="font-size:20px;margin:0 0 18px">แจ้งผลการประเมินและการปรับขึ้นเงินเดือน</h1><p>เรียน ${safeName}</p><p>งานบุคคล และงานการเงินและบัญชี ส่วนงานบริหารโรงเรียน มอ. วิทยานุสรณ์ สุราษฎร์ธานี<br>ขอแจ้งผลการประเมินผลการปฏิบัติงานและการปรับขึ้นเงินเดือน ปีการศึกษา ${academicYear} โดยมีรายละเอียดตามเอกสาร PDF ที่แนบมากับอีเมลฉบับนี้</p><p style="background:#fff4e5;border-left:4px solid #c77c00;padding:12px 14px"><strong>เอกสารลับเฉพาะบุคคล</strong><br>กรุณาอย่าส่งต่อหรือเผยแพร่เอกสารแนบให้บุคคลอื่น</p><p>หากมีข้อสงสัย กรุณาติดต่อกลับที่งานบุคคล และงานการเงินและบัญชี ส่วนงานบริหาร</p><p style="margin-top:26px">ขอแสดงความนับถือ<br><strong>งานบุคคล และงานการเงินและบัญชี<br>ส่วนงานบริหารโรงเรียน มอ. วิทยานุสรณ์ สุราษฎร์ธานี</strong></p></div></div></body></html>`;
}
